...
var currentWeek = [new Date(), new Date(), new Date(), new Date(), new Date(), new Date(), new Date()];
...
var monthAndYear = document.querySelector('.header__current-month-year');
...
var switchToTodaysWeek = todayBtn.addEventListener('click', todayWeekSwitcher);
