...
var splitLongEvent = function splitLongEvent(eventsList) {
  var newEvents = [];
...
var displayEvents = function displayEvents(eventList) {
...
var renderEvents = function renderEvents() {
  cleanEvents();
  getAllEvents().then(function (eventsList) {
    return splitLongEvent(eventsList);
  }).then(function (eventsList) {
    return displayEvents(eventsList);
  }).catch(function (err) {
